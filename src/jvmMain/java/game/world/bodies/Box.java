...
public class Box extends Body {
    public Box(ArrayRealVector pos, ArrayRealVector side1, ArrayRealVector side2) {
        ...
        addEdge(new FixedEdge(p1, p3, p1.getDistance(p3).getNorm()));
        addEdge(new FixedEdge(p2, p4, p2.getDistance(p4).getNorm()));
        addEdge(new FixedEdge(p3, p4, p3.getDistance(p4).getNorm()));
        addEdge(new FixedEdge(p1, p4, p1.getDistance(p4).getNorm()));
        addEdge(new FixedEdge(p2, p3, p2.getDistance(p3).getNorm()));
        addPoint(p1);
        addPoint(p2);
        addPoint(p3);
        addPoint(p4);
